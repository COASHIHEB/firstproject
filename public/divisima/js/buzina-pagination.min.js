...
(function($){$.fn.buzinaPagination=function(options){
  var settings=$.extend({prevnext:!0,prevText:"Previous",nextText:"Next",itemsOnPage:1},options);
  ...
  for(i=0;i<pagesTotal;i++){
      ...
      buzinaContent.children(":eq("+i+")").addClass(pageClass+(i+1)+" row content-page col-lg-12")
  }
...
$("#"+pagerId+" a").click(function(e){
  ...
  if(pageClicked==settings.prevText){
    ...
    var currentActiveNumber=currentActive.substring(currentActive.indexOf("--page")+7,currentActive.indexOf(" "));if(currentActiveNumber>1){
    ...
    var currentActive=$(".content-page-active").attr("class");
    var currentActiveNumber=currentActive.substring(currentActive.indexOf("--page")+7,currentActive.indexOf(" "));if(currentActiveNumber<pagesTotal){
      $(".content-page").removeClass("content-page-active");
      $("."+pageClass+(parseInt(currentActiveNumber)+1)).addClass("content-page-active")
    }
  }else{
    $(".content-page").removeClass("content-page-active");$("."+pageClass+pageClicked).addClass("content-page-active")
  }
})
}})(jQuery);

function createPagerDom(pagesTotal,pagerId,settings){var pagerConc="";
for(i=0;i<pagesTotal;i++){
  pagerConc+=`
      <li class="page-item" id="item${i + 1}">
        <a class="page-link" onclick='page(${pagesTotal},${i + 1})' href="#">${i + 1}</a>
      </li>`}
