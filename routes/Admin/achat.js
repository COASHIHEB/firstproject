...
app.post("/addAchat", redirectLogin, (request, response) => {
  require("../../models/Admin/achat").addAchat(request.body, resp => {
    response.json(resp);
  });
});

app.post("/deleteAchat", redirectLogin, (request, response) => {
  require("../../models/Admin/achat").deleteAchat(request.body, resp => {
    response.json(resp);
  });
});

app.post("/updateAchat", redirectLogin, (request, response) => {
